...
function scanner(){
    ...
    if(a.length != 0){
        if(a[0].disabled == false){
            ...
            var content = $('table > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(1) > td > table > tbody > tr:nth-child(1) > td > div > div')[3].textContent.split('');
            var i = 0;
            function a () {
                ...
                var input = $('table > tbody > tr:nth-child(2) > td > table > tbody > tr:nth-child(2) > td > input')[0];
                input.focus();
